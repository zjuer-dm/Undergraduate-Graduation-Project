...
# 命令行运行：
# CUDA_VISIBLE_DEVICES=2 bash run_r2r_30/main.bash train 2333
# CUDA_VISIBLE_DEVICES=0 bash run_r2r_30/main.bash eval 2333
# CUDA_VISIBLE_DEVICES=0 bash run_r2r_30/main.bash infer 2333