...
flag1="--exp_name release_r2r_30_grpo
      --run-type train
      ...
      GRPO_ORM.min_lr_ratio 1.0
      GRPO_ORM.log_every 5
      GRPO_ORM.load_from_ckpt False
...
# 命令行运行：
# CUDA_VISIBLE_DEVICES=1 bash run_r2r_30/main_grpo.bash train 2333