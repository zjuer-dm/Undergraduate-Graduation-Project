...
@baseline_registry.register_trainer(name="GRPO-20-ORM-old-ok-trainmin")
class RLTrainer(BaseVLNCETrainer):
    def __init__(self, config=None):
        ...
        # self.initial_num_envs = self.config.GRPO_ORM.batch_size # As per your _set_configs
        ...
        print(f"GRPO params: grpo_epsilon {self.grpo_epsilon}, grpo_beta {self.grpo_beta}, max_grad_norm {self.max_grad_norm}, grpo_update_epochs {self.grpo_update_epochs} \
              enable_amp {self.enable_amp}, need_ref_policy {self.need_ref_policy}, enable_all_dropouts {self.enable_all_dropouts}, dropout_rate {self.dropout_rate}")
    def _make_dirs(self):
