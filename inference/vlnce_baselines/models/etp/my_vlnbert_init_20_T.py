...
def get_vlnbert_models(config=None, dropout_rate=0.1, need_gsp=True, need_T=False, initial_T=5.0):
    
    from transformers import PretrainedConfig
    from vlnce_baselines.models.etp.my_vilmodel_cmt_20_T import GlocalTextPathNavCMT
    ...
    keywords = ['graph_query_text', 'graph_attentioned_txt_embeds_transform', 'global_sap_head', 'gsp_query_feature', 'gsp_query_text', 'gsp_attentioned_txt_embeds_transform', 
                'global_stage_head']
    ...
    vis_config.subtask_num = 3
    vis_config.max_subtask_type_embeddings = 10

    vis_config.need_T = need_T
    vis_config.initial_T = initial_T
    vis_config.need_gsp = need_gsp
